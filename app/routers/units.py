...
def to_unit_response(unit: Unit) -> UnitResponse:
    ...
    return UnitResponse(
        ...
        project_map_url=project.map_url if project else None,
...
async def create_unit(
    ...
    new_unit = Unit(
        ...
        map_url=unit_data.map_url,
        bathrooms=unit_data.bathrooms,
        max_guests=unit_data.max_guests,
        min_stay=unit_data.min_stay,
        max_stay=unit_data.max_stay,
        check_in_time=unit_data.check_in_time,
        check_out_time=unit_data.check_out_time,
